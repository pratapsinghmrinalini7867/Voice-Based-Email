...
if text == '1' or text == 'One' or text == 'one' or text=='option one':
    ...
    # mail.login(eid,pswd) #login part -- EDITED PART
    mail.login('pratapsinghmrinalini7867@gmail.com','eluuhcqxhbwdvqxv') #login part -- EDITED PART
    mail.sendmail(eid,'1940036@sliet.ac.in',msg) #send part
    print ("Congrats! Your mail has been send. ")
